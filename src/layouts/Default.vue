...
export default {
  ...
  computed: {
    ...
    blogTitle() {
      return this.$page.busers.edges[0].node.blogTitle
    },
    blogDescribe() {
      return this.$page.busers.edges[0].node.blogDescribe
    },
    avatarUrl() {
      return this.$page.busers.edges[0].node.avatarUrl
    },
    fontColor() {
      return this.$page.busers.edges[0].node.fontColor
    },
    useBackgroundImage() {
      return this.$page.busers.edges[0].node.useBackgroundImage
    },
    backgroundColorLeft() {
      return this.$page.busers.edges[0].node.backgroundColorLeft
    },
    backgroundColorRight() {
      return this.$page.busers.edges[0].node.backgroundColorRight
    },
    mini() {
      return this.$page.busers.edges[0].node.mini
    },
    webSites() {
      return this.$page.busers.edges[0].node.webSites
    },
  },
  watch: {
